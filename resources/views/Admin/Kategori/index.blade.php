                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title" style="font-weight: bold; font-family: 'Times New Roman', Times, serif;">Daftar Kategori</h3>
                            <div class="card-tools">
                                <a href="{{ url('Admin/Kategori/create') }}" class="btn btn-sm btn-success">
