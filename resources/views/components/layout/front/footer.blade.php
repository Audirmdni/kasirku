      ...
      <div class="row gy-4 g-md-3 border-bottom pb-8 pb-lg-9 justify-content-center">
        ...
        <div class="col-6 col-md-3 d-md-flex flex-column align-items-md-end pe-md-0">
          <div>
            ...
            <div class="mb-1 mb-lg-2"> <a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="{{ url('public/web') }}/assets/img/logos/App_Store.webp" alt="{{ url('public/web') }}/assets/img/logos/App_Store.webp" /></a></div><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="{{ url('public/web') }}/assets/img/logos/Play_Store.webp" alt="{{ url('public/web') }}/assets/img/logos/Play_Store.webp" /></a>
          </div>
        </div>
      </div>
